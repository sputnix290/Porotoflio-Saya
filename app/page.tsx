...
export default async function Home() {
  ...
  const languages = skillsList.filter((s) => s.kategori === "language");
  const frameworks = skillsList.filter((s) => s.kategori === "framework");
  const tools = skillsList.filter((s) => s.kategori === "tool");
